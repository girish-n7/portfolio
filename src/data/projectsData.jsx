...
let backendProjects = [
  ...
  },
  {
    ...
    description:
      "A reliable backend service to support the summarizer project, enabling efficient processing of content and delivering concise and coherent summaries. Hosted on Vercel.",
  },
  {
    _id: 3,
    name: "Chatbot backend",
    description:
      "A sophisticated backend service to power the AI chatbot, facilitating natural and engaging conversations while managing data seamlessly. Hosted on Vercel.",
  },
];

export { fullStackProjects, backendProjects };
